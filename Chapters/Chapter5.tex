...
\fig{Images/figure_1_13}{width = \textwidth}{\label{fig:px}}{S}

\fig{Images/adev_nc}{width = \textwidth, height=14 cm}{nc 24hrs.\label{fig:adev_nc}}{S}
\begin{figure}
...
\caption[S]{S.}
    \label{fig:np_x2}
\end{figure}
\fig{Images/sf_np_x3}{width = \textwidth}{np3 p10i37.\label{fig:np_x3}}{S}
\fig{Images/sf_np_x4_i100}{width = \textwidth}{np4 p0i100.\label{fig:np_x4}}{S}
