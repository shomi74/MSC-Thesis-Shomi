...
Chapter~\ref{ch:operation}, I have faced problems in terms of long
drift in the coil currents and also slower response of the prototype
system. I have been able to make the system faster by introducing
filter which enables me to change the sample frequency without adding
noise and will be discussed in Section~\ref{sec:freq}. In
Section~\ref{sec:pi_behave}, I have discussed the studies to
understand P and I term of PI control algorithm. But the coil current
drifting problem is still there. I have then changed the fluxgate
positions randomly to try to make condition number smaller and I have
also removed the outermost passive shielding layer to see if there is
any effect. For confirming the experimental coil current pattern, I
...
Section~\ref{sec:flux_place}. I have also implemented the new control
