...
excitation coil.  For that study, the $C_x^\pm$ coils were used to
...
\fig{Images/diag_comb_shield}{width=\textwidth}{Color map of diagonal matrix $\bm{\Sigma}$ found by SVD of experimentally measured
$\bm{M}$ for the available 12 fluxgate axes and for (a) 5 coils,
where the the $C_x^\pm$ coils are required to carry the same current,
and (b) 6 coils which, are permitted to carry any
current.\label{fig:diag_comb_shield}}{Experimental results for the
$\bm{\Sigma}$ matrix.}
...
\fig{Images/5c_pseudo_shield_y}{width = \textwidth}{$C_x^-$, $C_x^+$, $C_y^\pm$, $C_z^-$ and $C_z^+$. \label{fig:5c_pseudo_shield_y}}{S}
