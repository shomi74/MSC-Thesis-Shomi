...
Fig.~\ref{fig:center_6c_reg} shows the magnetic fluctuation reduction
on the central sensors in $z$, and $x$ axis for the 6-coil feedback
algorithm discussed in the previous Section.  Results are compared
when the outermost magnetic shield of the four-shell magnetic
...
cube.\label{fig:center_pseudo_5c_x}}{S}
...
\begin{itemize}
\item ``Natural'' fluctuations with feedback on.  In this case I tried to compensate typical changes in the laboratory at U.~Winnipeg.
...
\fig{Images/adev_nc}{width = \textwidth, height=14 cm}{(a) Field change $\Delta B$ in 12 fluxgate sensors placed within the coil cube for 24 hrs with feedback algorithm switched off. (b) Corresponding Allan deviation.\label{fig:adev_nc}}{S}

Fig.~\ref{fig:adev_nc} shows a measurement of fluxgate readings over a
24-hour period with the feedback system switched off.  This gives an
...
deviation shown in Fig.~\ref{fig:adev_nc}(b) rises with typically a
...
Fig.~\ref{fig:p10_i37_x}.  The main feature to be observed is the the
...
Fig.~\ref{np_x} shows the results of a run over a 4096~s period (just
over an hour).  In general 
