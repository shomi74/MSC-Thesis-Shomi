...
In Section~\ref{sec:metrics}, some quantitative measure of the magnetic compensation performance were discussed based on the previous studies on Refs.~\cite{bea,lins,rawlik}. In this section the effect on the internal sensors based on the feedback algorithm will be discussed. The Allan standard deviation for compensating ramp perturbation and corresponding shielding factor result will also be discussed.

\subsection{Internal Sensor Perturbations}
So far the magnetic field fluctuation reduction due to 12 fluxgate sensors are shown. The magnetic compensation also reduce the filed fluctuation on the central sensors that are placed in the origin of the coil cube and do not involve in the feedback algorithm. 

\fig{Images/center_6c_reg_sNs}{width = \textwidth}{6coils, shield, no shield, 10 mA perturbation, $k_c^p=0.0$, $k_c^i=1.0$, Regularized pseudo-inverse of $\bm{M^{-1}}$. \label{fig:center_6c_reg}}{S}

Fig.~\ref{fig:center_6c_reg} shows the magnetic fluctuation reduction on the central sensors in $z$, and $x$ axis for 6 coils configuration discussed in the previous Section with shield (left) and without shield (right). Aside from the vertical axis, the results are similar both with shield and no shield. The magnetic field changes are reduced by 0.5 nT in case of with shield with the uncompensated field change is 1.25 nT and 15 nT in case without shield with the uncompensated field change is 37 nT in $z$ axis. It is also seen that there is hardly any changes in $x$  due to perturbation.
...
\fig{Images/center_pseudo_perturb_5c_x}{width = \textwidth}{5coils, $C_x^\pm$ , shield, 10 mA perturbation, $k_c^p=0.0$, $k_c^i=1.0$, non-regularized pseudo-inverse of $\bm{M^{-1}}$.. \label{fig:center_pseudo_5c_x}}{S}
...
I have also studied in case of five coils configuration which also give similar results as can be seen by Fig.~\ref{fig:center_pseudo_5c_x} and Fig.~\ref{fig:center_5c_pseudo_s_xz}.
...
The Allan standard deviation and shielding factor were discussed in Section~\ref{sec:metrics}. 
...
\item Feedback on.  The shielding factor doesn't have to always be greater than one.  In fact it might be good to compare a ``noisy'' case to a ``quiet'' case.  It is possible that in some extremely quiet case you might do better by not doing anything.
\end{itemize}
...
\fig{Images/adev_nc}{width = \textwidth, height=14 cm}{(a) Field change $\Delta B$ in 12 fluxgate sensors placed within the coil cube for 24 hrs without feedback algorithm, (b) Corresponding Allan deviation.\label{fig:adev_nc}}{S}

\begin{figure}
     \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=7 cm]{Images/p10i37_x}
        \caption{p10i37.}
        \label{fig:1}
    \end{subfigure}\\[1ex]
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=7 cm]{Images/c_p10i37_x}
        \caption{p10i37, c zoomed}
        \label{fig:2}
    \end{subfigure}
\caption[S]{(a)5-coil feedback algorithm with the currents $C_x^+$ and $C_x^-$ are required to be a common current $C_x^\pm$. Coil currents are shown in the left panels while magnetic field changes are shown  in the right panels, (b) zoomed coil currents. The feedback parameters are $k_c^p=0.1$ and $k_c^i=0.37$.}
    \label{fig:p10_i37_x}
\end{figure}
...
\begin{figure}
     \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=7 cm]{Images/sf_np_x}
        \caption{np.}
        \label{fig:7}
    \end{subfigure}\\[1ex]
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=7 cm]{Images/c_np_x}
        \caption{np, c}
        \label{fig:8}
    \end{subfigure}
...
\begin{figure}
     \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=7 cm]{Images/sf_np_x2}
        \caption{np2.}
        \label{fig:9}
    \end{subfigure}\\[1ex]
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=7 cm]{Images/c_np_x2}
        \caption{np2, c}
        \label{fig:10}
    \end{subfigure}
\caption[S]{(a)5-coil feedback algorithm for ``natural'' fluctuations with the currents $C_x^+$ and $C_x^-$ are required to be a common current $C_x^\pm$. Magnetic field changes $\Delta B$ are shown in the left panels while corresponding Allan deviation (top) and shielding factor (bottom)  are shown in the right panels, (b) Coil currents. The feedback parameters are $k_c^p=0.1$ and $k_c^i=0.37$.}
...
\begin{figure}
     \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=7.5 cm]{Images/sf_ramp_x2}
        \caption{p10i37,ramp.}
        \label{fig:0_1}
    \end{subfigure}\\[1ex]
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=7.5 cm]{Images/c_ramp_x}
        \caption{p10i37,ramp, c}
        \label{fig:0_2}
    \end{subfigure}
...
\begin{figure}
     \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=7.5 cm]{Images/sf_ramp_x2_2}
        \caption{p10i37,ramp2.}
        \label{fig:0_3}
    \end{subfigure}\\[1ex]
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=\textwidth, height=7.5 cm]{Images/c_ramp_x2}
        \caption{p10i37,ramp2, c}
        \label{fig:0_4}
    \end{subfigure}
\caption[S]{S.}
