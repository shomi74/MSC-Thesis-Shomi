...
being zero, by studing the right singular vectors, which are
...
\end{equation}
The third coil, which generates $\frac{\partial B_z}{\partial z}$ is
...
$\frac{\partial B_z}{\partial z}$.  I implemented this in the Python
...
magnitude.  The condition number of the matrix is 2.005, which is a
