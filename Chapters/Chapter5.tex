...
\fig{Images/sf_5c_pseudo_ramp_x}{width = \textwidth}{5coils, $C_x^\pm$ , shield, 10~mA ramp over taus, $k_c^p=0.0$, $k_c^i=0.8$, non-regularized pseudo-inverse of $\bm{M^_1}$.. \label{fig:sf_5c_pseudo_ramp_x}}{S}
