...
Section~\ref{sec:r_pi_revisit}, we have discussed the studies to
understand regularization parameter and P and I term of PI control
...
one of the 12 sensors being used in the system has been displayed.  In
...
change significantly.  This is discussed further in
Sections~\ref{drifting1} and \ref{drifting2}.  For this reason I was
...
one of the 12 fluxgate axes, when the resolution index is changed.
