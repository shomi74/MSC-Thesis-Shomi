...
\fig{Images/ramsey2}{width =0.95\textwidth}{Ramsey's method of separated oscillatory fields, as applied to the measurement of the nEDM. The $\bm{E_0}$ field is parallel to $\bm{B_0}$ field on the left, whereas in the right they are antiparallel. \label{fig:ramsey}}{Ramsey's method of separated oscillatory fields.}
