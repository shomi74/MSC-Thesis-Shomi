...
\fig{Images/ramsey}{width = \textwidth}{Ramsey's method of separated oscillatory fields, as applied to the measurement of the nEDM. $\bm{E_o}$ field parallel to $\bm{B_o}$ field in the left where in the right they are antiparallel. \label{fig:ramsey}}{short caption}
