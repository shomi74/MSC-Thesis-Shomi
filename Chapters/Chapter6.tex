...
The goal of my MSc thesis work was to develop a working AMC prototype using multi-dimensional PID control to compensate magnetic field 
...
% An important example would be to amplify and acquire signals from 
% fluxgates located inside the passive shielding where all magnetic fields are very small.
...
% The plan of measurement of the perturbations is being developed and some experiments are ongoing at this time~\cite{beapriv}. On the other hand, a perturbation coil has already been built at TRIUMF~\cite{smith,cudmore}.
