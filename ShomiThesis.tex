...
\documentclass[a4paper, 11pt, final]{thesis}
%\documentclass[11pt,one side,final]{Thesis}
\usepackage[section]{placeins}
\usepackage{epsfig,bm,epsf,float}
% \usepackage{graphicx}
\usepackage{cite}
%use 'cite' for the bibliography
...
\usepackage{tgbonum,amsthm,framed,enumitem}
\usepackage{lineno,hyperref,amssymb,graphicx}
%%%%%%%%%%%%
