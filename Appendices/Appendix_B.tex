...
\lhead{\emph{Magnetic field inside the bulk of a spherical mu-metal shield}}
...
\fig{Images/sphere_1}{width = \textwidth}{Spherical shell in a uniform magnetic field.\label{fig:sphere_ns}}{Spherical shell in a uniform magnetic field.}
